...
(function() {
    var provider = app.data.pizzaHut = new Everlive({
            offlineStorage: true,
            appId: '7stqcr4vsmhtiu0e',
            scheme: 'https',
            authentication: {
                persist: true
            }
        }),
        accessTokenCacheKey = 'pizzaHut_access_token',
...
// START_CUSTOM_CODE_pizzaHut
// Add custom code here. For more information about custom code, see http://docs.telerik.com/platform/screenbuilder/troubleshooting/how-to-keep-custom-code-changes

// END_CUSTOM_CODE_pizzaHut